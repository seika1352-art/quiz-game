...
const API_URL =
  "https://script.google.com/macros/s/AKfycbzP418ZBjOkOdspG2SQDr1HZXroA4gn_zIQooPD6XvJS284i7m1dR8nTaX2OLVS7aJ7/exec";
...
async function loadQuestions() {
  ...
  try {
    ...
    if (allQuestions.length === 0) {
      ...
      throw new Error(
        "問題が見つかりませんでした。Googleスプレッドシートの列名を確認してください。"
      );
